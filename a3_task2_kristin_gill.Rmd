...
All examples use built-in data sets in R, so you will not load any data for this task. 
...
sw_split_name <- starwars %>% 
  separate(col = name,
           ...
           sep = "-")
# line 49 drops the part after the second dash
```
